...
![image-20250928133845411](../pictures/image-20250928133845411.png)![image-20250928133908862](../pictures/image-20250928133908862.png)

而SVM要做的就是把这两个复杂的表达式转换为线性的表达式，用函数形态来逼近就是这样的两个图：

![image-20250928134015524](../pictures/image-20250928134015524.png)

同时，替换了原代价函数上正则化系数λ，放了一个C系数在代价函数上，因此SVM的代价函数的数学表达就如下：

![image-20250928133819108](../pictures/image-20250928133819108.png)

有时，SVM也被称作大间隔分类器：

![image-20250928140445213](../pictures/image-20250928140445213.png)

考虑这样一个例子，这是一个小间隔分类器，顾名思义就是决策边界和样本之间的距离太小了。这样一个例子就可以证明为什么SVM是一个大间隔分类器，首先考虑SVM的优化目标：

![image-20250928140624645](../pictures/image-20250928140624645.png)
...
![image-20250928141722476](../pictures/image-20250928141722476.png)

我们就考虑这三个特征构成的特征多项式：

![image-20250928144433740](../pictures/image-20250928144433740.png)
...
![image-20250928144427997](../pictures/image-20250928144427997.png)

吴恩达给出了一种选择landmarks的方式，就是使所有的训练样本（x,y）中的x成为landmark，例如：

![image-20250928145607020](../pictures/image-20250928145607020.png)

然后轮询输入的特征值，遍历这个点与其他所有点的相似度，f1到fm，构建一个特征向量。其中f0定义为1，因此特征向量就是一个m+1行的列向量。 

![image-20250928145748901](../pictures/image-20250928145748901.png)

因此，我们就可以使用这个特征向量作为原本的输入样本的替代：

![image-20250928151316025](../pictures/image-20250928151316025.png)

其中，不同的σ和λ对于整个模型的结果的影响如下：

![image-20250928152557342](../pictures/image-20250928152557342.png)
...
![image-20250928161035427](../pictures/image-20250928161035427.png)
...
![image-20251014125605491](../pictures/image-20251014125605491.png)
...
![image-20251014130752719](../pictures/image-20251014130752719.png)
...
![image-20251014131631088](../pictures/image-20251014131631088.png)
...
![image-20251014134101939](../pictures/image-20251014134101939.png)
