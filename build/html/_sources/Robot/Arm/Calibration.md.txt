...
​	![image-20250503151047449](../../pictures/image-20250503151047449.png)
...
\end{bmatrix}
$$
​	其中，P由一个内参矩阵与一个外参矩阵组成，其中外参矩阵的系数与相机的世界坐标有关，这一部分我们在手眼标定部分已经实现，因此只需要标定内参矩阵即可，它由焦距与光学中心组成，如式3-31所示，其中，fx,fy为相机的焦距的横纵坐标；cx, cy为相机的光学中心在接受面的横纵坐标。目前，常用到的标定方式为张正友标定法。
$$
K = 
\begin{bmatrix}
f_x & 0 & c_x \\
