...
![image-20250909123529338](../pictures/image-20250909123529338.png)
...
![image-20250909124036533](../pictures/image-20250909124036533.png)![image-20250909124219516](../pictures/image-20250909124219516.png)
...
![image-20250909133757991](../pictures/image-20250909133757991.png)
...
![image-20250909141431181](../pictures/image-20250909141431181.png)

为了简化问题，只看$J$关于$w$的函数，形如下图，我们将重复这样的过程，来逐渐降低代价函数的值，以确定最优的w的位置。

![image-20250909141902380](../pictures/image-20250909141902380.png)
$$
...
![image-20250909143504296](../pictures/image-20250909143504296.png)

实际上这里就是一个正向推导的过程，最关键的是接下来如何实现红色线的反向过程。

![image-20250909143540109](../pictures/image-20250909143540109.png)

在Logistic回归的过程中，假设样本只有两个，他就是这样的：

![image-20250909144102998](../pictures/image-20250909144102998.png)
...
![image-20250910100006657](../pictures/image-20250910100006657.png)

一个简易的神经网络如图所示：

![image-20250910100035635](../pictures/image-20250910100035635.png)
...
![image-20250910100946123](../pictures/image-20250910100946123.png)
...
![image-20250910102753753](../pictures/image-20250910102753753.png)
...
![image-20250910105935005](../pictures/image-20250910105935005.png)

### 2.3 Meaning of non-linear Activation Function（非线性激活函数的使用意义）

试想：去掉隐藏层的激活函数或使用线性的激活函数，其推导就是这样的过程：

![image-20250910110745346](../pictures/image-20250910110745346.png)
...
![image-20250910193830085](../pictures/image-20250910193830085.png)
...
![image-20250910200135583](../pictures/image-20250910200135583.png)
...
![image-20250910210327515](../pictures/image-20250910210327515.png)
...
![image-20250912160822732](../pictures/image-20250912160822732.png)
...
![image-20250914125156816](../pictures/image-20250914125156816.png)
...
![image-20250914134646524](../pictures/image-20250914134646524.png)
...
![image-20250914140039327](../pictures/image-20250914140039327.png)
...
![image-20250914142835407](../pictures/image-20250914142835407.png)
...
x = x/\sigma
$$
![image-20250914143423299](../pictures/image-20250914143423299.png)
...
![image-20250914163550932](../pictures/image-20250914163550932.png)

简短来说，就是一个dw/db的低通滤波器，使得二者能够缓慢且平滑的下降，变成红线那样，常用的$\beta$是0.9![image-20250914163738323](../pictures/image-20250914163738323.png)

### 3.10 RMSprop

 ![image-20250914164130494](../pictures/image-20250914164130494.png)

和Momentum方法不太一样的是，RMSprop在横轴上的摆动幅度很大，而纵轴很小。Momentum恰恰相反。

![image-20250914164341267](../pictures/image-20250914164341267.png)
...
![image-20250914154737109](../pictures/image-20250914154737109.png)
...
![image-20250915093347005](../pictures/image-20250915093347005.png)
...
![image-20250920110404741](../pictures/image-20250920110404741.png)

这是LeNet-5的网络架构，为手写数据集（灰度图）设计的。

#### 4.1.2 Alexnet

 ![image-20250920111736186](../pictures/image-20250920111736186.png)

#### 4.1.3 VGG-16

![image-20250920130320560](../pictures/image-20250920130320560.png)

### 4.2 ResNets 残差网络

![image-20250920132352360](../pictures/image-20250920132352360.png)
...
![image-20250920132914594](../pictures/image-20250920132914594.png)

卷积含义的全连接层

![image-20250920134400926](../pictures/image-20250920134400926.png)
...
![image-20250920135411231](../pictures/image-20250920135411231.png)

这就是一个inception network

实际上，再中间的某些连接层输出，也会通过两个FC，做一次softmax做预测。为什么叫inception，是因为翻译过来是盗梦空间，里面有一段这样的台词和梗图：

![image-20250920135653715](../pictures/image-20250920135653715.png)

为了降低deeper的代价，他们选择了降低计算成本，所以建立了inception单元。

### 4.4 Transfer Learning

![image-20250920140721430](../pictures/image-20250920140721430.png)
...
![image-20250923140229213](../pictures/image-20250923140229213.png)

以一层为例，介绍这个神经网络的计算流程，值得注意的是这里用于计算a1和y1的权重是两组，因此实际上这个网络一层就具有至少两组向量，一组用于承接上一次的激活输出、本层的文本输入与bias/另一层负责将本层的激活输出转换为神经网络输出。

![image-20250923140719248](../pictures/image-20250923140719248.png)
